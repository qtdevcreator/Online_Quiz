...
<form name="upform" action="ListStudIds.jsp" method="post" enctype="multipart/form-data" onSubmit="return checkvalidate102()">
<h3 class="consultant-services">List Student Ids</h3><br>
<table CELLSPACING="0" CELLPADDING="5" WIDTH="550" height="80" align="center">
<tr align="center">
<td align="center" width="200">Excel File</td>
<td align="center" width="150"><INPUT type="file" name="file"></td>
<td width="200" align="left"><div id="userIdMessage"></div></td>
</tr>
<tr align="center">
