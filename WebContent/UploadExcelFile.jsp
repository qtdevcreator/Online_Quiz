...
<script type="text/javascript">
function checkvalidate101()
{
	var x=document.forms["upform"]["file1"].value;
	
	if (x==null || x=="")
	{
		document.getElementById("userIdMessage").innerHTML = "Please select excel file!";
		return false;
	}
	else
	{
...
<form name="upform" action="UploadExcelFileSuccess.jsp" method="post" enctype="multipart/form-data" onSubmit="return checkvalidate101()">
<h3 class="consultant-services">Upload Question Bank</h3><br>
<table CELLSPACING="0" CELLPADDING="5" WIDTH="550" align="center">
<tr align="center">
<td align="center" width="200">Excel File</td>
<td align="center" width="200"><INPUT type="file" name="file1"></td>
<td width="250" align="left"><div id="userIdMessage"></div></td>
</tr>
<tr align="center">
<td align="center" colspan="2">
<input class="btn btn-cst-primary pull-right"  type="submit" value="Go"></td><td></td>
</tr>
</table>
</form>
</td></tr></table>
