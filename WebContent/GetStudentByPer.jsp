...
function checkvalidate99999()
{
	...
	if (x1==0)
	{
		document.getElementById("userIdMessage19992").innerHTML = "Please select Test!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage19992").innerHTML = "";
	}
	if (x2==0)
	{
		document.getElementById("userIdMessage19993").innerHTML = "Please select Test subcategory!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage19993").innerHTML = "";
	}	
	if (x3==0)
	{
		document.getElementById("userIdMessage19994").innerHTML = "Please select batch!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage19994").innerHTML = "";
	}		
}
</script>
...
<h3 class="consultant-services">List Students By Percentage</h3><br>
Select Quiz<br>
<FORM name="Batchform" action="GetStudentDetails.jsp" onSubmit="return checkvalidate99999()">
<input type="hidden" name="action" value="PerSearch"/>
<input type="hidden" name="oper1" value="8"/>
<table align="center" width="500">
	...
	<td align="left"><select name="stest" onchange="showTestscat(<%=cid%>,this.value)">
		...
		<td  align="center" width="150"><div id="userIdMessage19992"></div></td></tr>
	...
	<td   align="left"> 
		...
		<td  align="center" width="150"><div id="userIdMessage19993"></div></td></tr>
	...
	<td   align="left">
		...
		<td  align="center" width="150"><div id="userIdMessage19994"></div></td></tr>		
