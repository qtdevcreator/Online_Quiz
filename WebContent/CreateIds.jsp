...
<form name="upform" action="genStudIds.jsp" method="post" enctype="multipart/form-data" onSubmit="return checkvalidate103()">
<h3 class="consultant-services">Generate Student Ids</h3>
<table CELLSPACING="0" CELLPADDING="5" WIDTH="550" height="80" align="center">
<tr align="center">
<td align="center" width="200">Excel File</td>
<td align="center" width="200"><INPUT type="file" name="file"></td>
