...
%>
<% 
	String ssucc = request.getParameter("action");
	String type = request.getParameter("type");
	if(type.equals("Admin"))
	{					
		slink = "AdminLogin.jsp";
		smenu = "AdminMenu.jsp";
	}
	...
	String stat = "";
	int icol = 6;
	if(ssucc.equals("SucessfullLogin"))
	{
...
{ %>  
    <jsp:include page="QuizHeader.jsp" flush="true"/>
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <% if(stat.equals("Successful Login!")) { %>
        ...
        <div class="student-bg">
         <div class="container">
            <div class="row">
                <div class="col-md-<%=icol%> col-md-offset-3">
                    <div class="main-header-input-center">
                    <% if(ssucc.equals("SucessfullLogin")) { %>
                   		<jsp:include page="LHSMenu.jsp" flush="true"/>
                   	<% } else { %>
