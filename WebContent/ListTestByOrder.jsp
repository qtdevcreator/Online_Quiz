    	...
    	<div class="row">
                ...
                <div class="">
                    <header class="page-header text-center" style=" color:#2aa3d5; text-transform:uppercase; font-size:18px;">
                       List Test By Alphabetical Order
                    </header>
                    <div class="box-lg">
...
<% if(chkval1.equals("true"))
{ %>
<tr bgcolor="#fff" align="center" height="20" ><td colspan="4" align="center"><h3 class="consultant-services">Test Categories arranged by alphabetical order</h3></td></tr>
<% } %>
<% 
...
%>	 	
	...
	%>
	<td  align="center">
	<div style="height: 220px; width:150px; overflow-y: auto">
	<table align="center" width="150" height="220">
	<thead>
	...
	ArrayList<Test> clist =  dbBean.getTestWithAlph(mchar,cid);
	...
	<%
		...
		while (iterator.hasNext()) {
			Test prod = (Test) iterator.next();
		%>
		<tr   height="20" align="center">		
	<td align="center"><a href="GetTestDetails.jsp?action=<%=action%>&ID=<%=prod.getID()%>"><%=prod.getTestname()%></a></td></tr>
	<%
		j++;
		} //end while 
	} else {
