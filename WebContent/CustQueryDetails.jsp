...
function checkvalidate()
{
	...
	{
		document.getElementById("userIdMessage1").innerHTML = "Enter atleast 1 search criteria!";
		return false;
	}
	else
	{
...
//dbBean.initDB();
CustQuery students = null;
students = dbBean.GetCustQueryInfo(Integer.parseInt(id),cid);
String compname1 = "";
...
<TABLE width="670" height="490" align="center">
<TR align="center" valign="top"><td align="center">
<h3 class="consultant-services">Read Student Query Message</h3>
<DIV style="height: 490px; width:670px; overflow-y: auto;">
<TABLE width="670" height="490" align="center">
<TBODY>	
	<TR  align="center" height="30">
	<TD  align="center">Name</TD>
	<TD  align="center"><%=students.getName()%></TD>
	</TR>
	<TR  align="center" height="30">
	<TD  align="center" colspan="2">Message</TD>
	</TR>
	<TR  align="center">
	<TD  align="center" colspan="2"><%=students.getMsg()%></TD>
	</TR>
	</TBODY>
	</TABLE>
	</DIV>
