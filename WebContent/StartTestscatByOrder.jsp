...
String keyword = "";
if (action.equals("TestscatByOrder")) 
{
...
<%
int mcnt = 0;
if(action.equals("TestscatByOrder") && eflg==false)
{
	ArrayList<TestSubCat> clist1 = dbBean.getTestSubCatWithAlphByCid(cid,keyword);
	...
	if(iterator2.hasNext())
	{
		...
		<tbody>
		<tr  align="center" height="20" ><td align="center" colspan="2">Start Test Listed With First Character as <%=keyword%> in Test Sub Category</td></tr>
		<tr align="center">
<% 
