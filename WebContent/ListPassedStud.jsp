...
function checkvalidate39999()
{
	...
	if (x1==0)
	{
		document.getElementById("userIdMessage39992").innerHTML = "Please select Test!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage39992").innerHTML = "";
	}
	if (x2==0)
	{
		document.getElementById("userIdMessage39993").innerHTML = "Please select Test subcategory!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage39993").innerHTML = "";
	}	
	if (x3==0)
	{
		document.getElementById("userIdMessage39994").innerHTML = "Please select batch!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage39994").innerHTML = "";
	}		
}
</script>
...
<h3 class="consultant-services">List Passed Students</h3><br>
Select Quiz<br>
<FORM name="Batchform" action="GetStudentDetails.jsp" onSubmit="return checkvalidate39999()">
<input type="hidden" name="action" value="ListPass"/>
...
<table align="center" width="500">
	...
	<td align="left"><select name="stest" onchange="showTestscat(<%=cid%>,this.value)">
		...
		<td  align="center" width="150"><div id="userIdMessage39992"></div></td></tr>
	...
	<td   align="left"> 
		...
		<td  align="center" width="150"><div id="userIdMessage39993"></div></td></tr>
	...
	<td   align="left">
		...
		<td  align="center" width="150"><div id="userIdMessage39994"></div></td></tr>		
