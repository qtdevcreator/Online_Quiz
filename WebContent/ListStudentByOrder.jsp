...
<table align="center" WIDTH="620" height="490">
<tbody>
<tr  align="center" height="20" ><td colspan="4" align="center"><h3 class="consultant-services">Student names arranged by alphabetical order</h3></td></tr>
<% 
...
%>	 	
	...
	%>
	<td  align="center">
	<div style="height: 220px; width: 155px; overflow-y: auto">
	<table align="center" width="155" height="220">
	<thead>
	...
	ArrayList<CustomerInfo> clist =  dbBean.getStudentWithAlph(mchar,cid);
	...
	<%
		...
		while (iterator.hasNext()) {
			CustomerInfo prod = (CustomerInfo) iterator.next();
		if(j%2==0)
		{
		%>
		...
		%>
	<td align="center"><a href="GetStudentDetails.jsp?action=List2&ID=<%=prod.id%>"><%=prod.stuname%> <%=prod.stlname%></a></td></tr>
	<%
		j++;
		} //end while 
	} else {
	%>
	<tr align="center"  height="20"><td align="center">No Students!</td></tr>
	<%	} //end if%>	
	</tbody>
	</table>    
	</div>
