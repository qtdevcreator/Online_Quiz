...
int testscatid = 0;
if ((action.equals("ByOrder")) || (action.equals("ByOrder1")) || action.equals("StartQuiz")) 
{
	testscatid = Integer.parseInt(request.getParameter("ID"));	
}
%>
...
<%
int mcnt = 0;
if((action.equals("ByOrder")) || (action.equals("ByOrder1")) || (action.equals("StartQuiz")) && eflg==false)
{
	ArrayList<TestSubCat> clist1 = dbBean.getTestscatById(testscatid);
	...
	if(iterator2.hasNext())
	{
		...
		<tbody>
		<% if(action.equals("ByOrder1")) { %>
		<tr  align="center" height="20" ><td align="center" colspan="2">Batch Details</td></tr>
		<% } else { %>
		<% if(chkval1.equals("true"))
{ %> <tr  align="center" height="20" ><td align="center" colspan="2"><h3 class="consultant-services">Test Sub Category Details</h3></td></tr>		
	<% } else { %>
		<tr  align="center" height="20" ><td align="center" colspan="2">Test Sub Category Details</td></tr>
		<% } %>
		<% } %>
		<tr align="center">
<% 
...
<%
	...
	{		
		while(iterator3.hasNext())
		{
			...
			if(action.equals("ByOrder") || action.equals("ByOrder1"))
			{
			%>
