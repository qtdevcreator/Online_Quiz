...
function checkvalidate28220()
{
	var x=document.forms["f1"]["stest"].value;
	var x1=document.forms["f1"]["stestscat"].value;
	var x5=document.forms["f1"]["lvl"].value;
	
	if (x==0)
	{
		document.getElementById("userIdMessage2820").innerHTML = "Please select test!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage2820").innerHTML = "";
	}
	if (x1==0)
	{
		document.getElementById("userIdMessage2830").innerHTML = "Please select test subcategory!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage2830").innerHTML = "";
	}
	if (x5==0)
	{
		document.getElementById("userIdMessage2850").innerHTML = "Please select level!";
		return false;
	}
	else
	{
		document.getElementById("userIdMessage2850").innerHTML = "";
	}
}
...
if (action != null && action.equals("listquestion")) 
{
	...
	lvl = Integer.parseInt(request.getParameter("lvl").toString());
	...
	clist = dbBean.getQuestionByCompLvl(comid, stest, stestscat, lvl);
	comid11 = comid;
	stest11 = stest;
...
if (action != null && action.equals("deleteQuestion")) 
{
	...
	lvl111 = Integer.parseInt(request.getParameter("lvl111").toString());
...
<form name="f1" onSubmit="return checkvalidate28220()">
...
{ %>
<h3 class="consultant-services">List Question-Choices By Level</h3><br>
<% } %>
...
<% } else { %>
<h3 class="consultant-services">Test Details</h3><br>
<% } %>
<table align="center" width="500" >
	...
	<td  align="center" width="200"><div id="userIdMessage2810"></div></td></tr>
	<% } %>
	...
	<% } %>	
		<td  align="center" width="200"><div id="userIdMessage2820"></div></td></tr>
...
<td   align="left"> 
	...
	<% } %>	
		<td  align="center" width="200"><div id="userIdMessage2830"></div></td></tr>
		<tr><td  align="center" width="150">Level</td>
		<td   align="left"><select name="lvl">
					<option value="0">Select</option>
					<option value="1">Easy</option>
					<option value="2">Medium</option>
					<option value="3">Difficult</option>
					</select></td>
		<td  align="center" width="200"><div id="userIdMessage2850"></div></td></tr>				
		<% if (action.equals("List") || action.equals("listquestion") || action.equals("ListQues")) 
	{ %>
...
<input type="hidden" name="lvl111" value="<%=lvl111%>"/>
...
<tr align="center" height="50"><td  align="center" colspan="5"><h3 class="consultant-services">Question list with level selected as <%=slevel1%></h3></TD></TR>
